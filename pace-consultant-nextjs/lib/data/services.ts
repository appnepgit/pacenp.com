...
export const services: Service[] = [
  {
    ...
    title: 'Architectural Design, Planning & Master Planning',
    description:
  ...
  },
  {
    ...
    title: 'Working Drawings & Construction Supervision',
    description:
  ...
  },
  {
    ...
    description:
      'Environmental Impact Assessment, Initial Environmental Examination, and preliminary environmental impact assessment studies for development projects.',
    icon: 'chart',
  ...
  },
  {
    ...
    description:
      'Technical audit services for road projects, irrigation systems, buildings, and other infrastructure and development projects to assess quality and compliance.',
    icon: 'tasks',
  ...
  },
  {
    ...
    description:
      'Research studies, data collection, financial analysis, economic assessment, and development-related analytical services for projects and investments.',
    icon: 'chart',
